...
export const products: Product[] = [
  ...
  },
  {
    ...
    images: [
      ...
      "/images/catalog-batch/batch-03.png",
      "/images/catalog-batch/batch-05.png",
      "/images/catalog-batch/batch-06.png",
      "/images/catalog-batch/batch-07.png",
      "/images/catalog-batch/batch-08.png",
      "/images/catalog-batch/batch-10.png",
      "/images/catalog-batch/batch-12.png",
      "/images/catalog-batch/batch-13.png",
      "/images/catalog-batch/batch-15.png",
      "/images/catalog-batch/batch-20.png",
      "/images/catalog-batch/batch-23.png",
      "/images/catalog-batch/batch-24.png",
      "/images/catalog-batch/batch-25.png",
    ],
    availableQuantity: 5,
  },
  {
    slug: "catalog-awards-display",
    sku: "G30",
    name: "دروع وتكريمات مع عرض",
    shortDescription:
      "قطع تكريمية في صناديق عرض أنيقة: مجسم علم بتفاصيل معدنية، ودرع تذكاري بلوحة نقش وبرواز ذهبي — مناسبة للمناسبات الرسمية وإهداءات التقدير.",
    contents: ["درع أو مجسم في واجهة عرض", "صندوق عرض فاخر", "تفاصيل معدنية وخشبية"],
    price: "حسب الطلب",
    category: "تكريمات",
    giftTier: "luxury",
    images: ["/images/catalog-batch/batch-04.png", "/images/catalog-batch/batch-09.png"],
    availableQuantity: 3,
  },
  {
    slug: "catalog-arabic-inlay-boxes",
    sku: "G31",
    name: "صناديق خشب بزخرفة وخط عربي",
    shortDescription:
      "صناديق خشبية فاخرة مزينة بخط عربي منمق وإطارات لؤلؤية أو فاتحة، منها عبارة «حبك في قلبي إلى يوم القيامة» — هدايا رمزية للمناسبات العائلية والزواج.",
    contents: ["صندوق خشب بزخرفة عربية", "إطار دائري أو مستطيل للنقش", "لمسة حرفية تقليدية"],
    price: "حسب الطلب",
    category: "تراثي",
    giftTier: "luxury",
    images: ["/images/catalog-batch/batch-11.png", "/images/catalog-batch/batch-16.png"],
    availableQuantity: 4,
  },
  {
